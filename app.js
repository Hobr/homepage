...
import workText from 'raw-loader!./info/work.txt';
import pgpText from 'raw-loader!./info/pgp.txt';
import headerHTML from 'raw-loader!./header.html';
let styleText = [0, 1, 2, 3].map((i) => require('raw-loader!./info/styles' + i + '.css').default);
